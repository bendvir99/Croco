...
elseif game.PlaceId == 86322978 then
	...
	Teleport:NewButton("Cam 01", "Teleports you to cam 01", function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.Position = Vector3.new(234, 4, -103)
	end)
	Teleport:NewButton("Cam 02", "Teleports you to cam 02", function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.Position = Vector3.new(202, 4, -106)
	end)
	Teleport:NewButton("Cam 03", "Teleports you to cam 03", function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.Position = Vector3.new(190, 4, -106)
	end)
	Teleport:NewButton("Cam 04", "Teleports you to cam 04", function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.Position = Vector3.new(187, 5, -73)
	end)
	Teleport:NewButton("Cam 05", "Teleports you to cam 05", function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.Position = Vector3.new(217, 4, -76)
	end)
	Teleport:NewButton("Cam 06", "Teleports you to cam 06", function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.Position = Vector3.new(239, 4, -80)
	end)
	Teleport:NewButton("Cam 07", "Teleports you to cam 07", function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.Position = Vector3.new(192, 4, -38)
	end)
	Teleport:NewButton("Cam 08", "Teleports you to cam 08", function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.Position = Vector3.new(219, 5, -38)
	end)
	Teleport:NewButton("Cam 09", "Teleports you to cam 09", function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.Position = Vector3.new(240, 4, -39)
	end)
	Teleport:NewButton("Cam 10", "Teleports you to cam 10", function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.Position = Vector3.new(243, 4, -59)
	end)
	Teleport:NewButton("Cam 11", "Teleports you to cam 11", function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.Position = Vector3.new(235, 4, -49)
	end)
	Teleport:NewButton("Cam 12", "Teleports you to cam 12", function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.Position = Vector3.new(255, 4, -72)
	end)
	Teleport:NewButton("Cam 13", "Teleports you to cam 13", function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.Position = Vector3.new(252, 4, -95)
	end)
	Teleport:NewButton("Cam 14", "Teleports you to cam 14", function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.Position = Vector3.new(244, 4, -109)
	end)
	Teleport:NewButton("Private", "Teleports you to private room", function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.Position = Vector3.new(264, 4, -59)
	end)
	Teleport:NewButton("Hidden", "Teleports you to hidden room", function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.Position = Vector3.new(268, 4, -96)
	end)
	Teleport:NewButton("Kitchen", "Teleports you to kitchen room", function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.Position = Vector3.new(188, 4, -58)
	end)
